...
var encoder = function (req:Express.Request, res:Express.Response, next:any) {
...
var decoder = function (req:Express.Request, res:Express.Response, next:any) {
    var input = Object.values(req.body);
...
var cacheEncoder = function (req:Express.Request, res:Express.Response, next:any) {
    var input = Object.values(req.body);
    var encodedInput = input.map(function (item) {
        return rot13(item);
    });
    ...
    var responseArray = encodedInput.map(function (inputItem) {
        redisClient.exists(inputItem, function (err:Error, reply:number) {
            if (reply === 1) {
                console.log('Data already exists in Redis..!');
                redisClient.get(inputItem, function (err:Error, reply:any) {
                    returnValue = reply;
                ...
                redisClient.set(inputItem, inputItem, function (error:Error, reply:any) {
